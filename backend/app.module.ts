...
import { GroupPreschoolerModule } from './group_preschooler/group_preschooler.module';
import { EventRegistrationModule } from './event_registration/event_registration.module';
import { AuthModule } from './src/auth/auth.module';
import { ParentAndPreschoolerModule } from './parent_and_preschooler/parent_and_preschooler.module';
import { GameModule } from './src/game/game.module';
import { AIController } from './src/controllers/ai.controller';  // Добавили AIController
import { AIService } from './src/services/ai.service'; // Добавили AIService
